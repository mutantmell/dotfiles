...
for wrapper in agent-fmt agent-preflight agent-preflight-quick agent-preflight-full agent-checks agent-build-check agent-smoke agent-pr-create agent-pr-status agent-ci-status agent-ci-logs agent-pr-comments agent-pr-comment; do
