...
for wrapper in agent-fmt agent-preflight agent-preflight-quick agent-preflight-full agent-checks agent-build-check agent-smoke agent-ci-render-summary agent-ci-post-summary agent-pr-status agent-pr-comments agent-pr-comment; do
