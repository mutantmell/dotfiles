...
_This is the same finding as Module 1, Security Concern #2, confirmed here at the generated output layer — the DSL-level gap propagates to the generated ruleset as expected._
