...
- **SMB + Seafile without Syncthing** — Would require a webhook/script to extract files from Seafile's chunked storage to `/data/media/staging/manual/`. Adds complexity; Syncthing is simpler for the direct-to-filesystem delivery.
