# NixOS integration test for yggdrasil router configuration
#
...
#
# Tests the actual yggdrasil zone config and firewall rules on a flat VM topology.
...
let
  # Hardcoded IPs from network registry (same as hosts/yggdrasil/default.nix)
...
pkgs.testers.nixosTest {
  name = "router6-yggdrasil";

  nodes = {
    router = { config, pkgs, lib, ... }: {
      imports = [ ../../modules/router6 ];

      # Flat topology: eth1-eth7 map to yggdrasil's zones
      ...
      router6 = {
        ...
        # ============================================================
        # Zones: identical to hosts/yggdrasil/default.nix
        # ============================================================
        zones = {
          external = {
            icmpEcho = "disable";
        ...
        firewall = {
          ...
          extraForwardRules = [
            ...
            # DMZ -> tyr (ACME certificate issuance)
            { iifname = "eth7"; oifname = "eth3";
          ...
          # DNS interception rules (same IPs as yggdrasil)
          extraNatRules = [
            {
  ...
  testScript = ''
    ...
    # ======================================================================
    # 4. EXTRA FORWARD RULES (yggdrasil-specific)
    # ======================================================================

    # DMZ -> infra selective: surtr -> mimir OIDC
    # Note: nftables DSL renders oifname AFTER ip saddr/daddr
    print("Test 4a: DMZ -> infra: surtr -> mimir OIDC rule present")
    ...
    # DMZ -> infra: DMZ -> tyr ACME
    print("Test 4b: DMZ -> infra: DMZ -> tyr ACME rule present")
    ...
    print("")
    print("=" * 70)
    print("YGGDRASIL ROUTER TESTS COMPLETE")
    print("=" * 70)
